...
You can get a `reply_token` with a [webhook event object](https://devdocs.line.me/#webhook-event-object). See the documentation for the  `parse_events_from_json($json)` method.

You can also see the online API reference documentation. [https://devdocs.line.me/#reply-message](https://devdocs.line.me/#reply-message)
...
You can get `user_id`, `room_id` or `group_id` with a [webhook event object](https://devdocs.line.me/#webhook-event-object). See the documentation for the  `parse_events_from_json($json)` method.

You can also see the online API reference documentation. [https://devdocs.line.me/#push-message](https://devdocs.line.me/#push-message)
...
You can get a `room_id` with a [webhook event object](https://devdocs.line.me/#webhook-event-object).
...
You can get a `group_id` with a [webhook event object](https://devdocs.line.me/#webhook-event-object).
And see also `parse_events_from_json($json)` method's document.

## get\_message\_content($message\_id)

Get the original file which was sent by the user.
...
You can get a `message_id` by a [Webhook Event Object](https://devdocs.line.me/#webhook-event-object).
See the documentation for the  `parse_events_from_json($json)` method.
...
When the `LINE::Bot::API::Builder::SendMessage` class is used, it is possible to build a send message object easily.
